...
import { Cardinality, EAST_SHADING, getBuildingCornerByAngle, getBuildingCornerByCardinality, getPointAlongEdge, WEST_SHADING, type Segment, type SegmentProperties } from "../segmentUtils";
